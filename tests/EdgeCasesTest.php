...
final class EdgeCasesTest extends TestCase
{
    ...
    public function testFutureDate(): void
    {
        ...
        $service = new NationalBankOfRomaniaService(clock: $clock);

        $response = $service->send(new HistoricalExchangeRateRequest('EUR', 'RON', $future));
        self::assertInstanceOf(ErrorResponse::class, $response);
    ...
    public function testHttpFailure(): void
    {
        ...
        $service = new NationalBankOfRomaniaService(httpClient: $http);
